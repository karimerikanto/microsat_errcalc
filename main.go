...
import (
	"fmt"
	"karim/microsat_errcalc/analyzer"
	"karim/microsat_errcalc/reader"
	"karim/microsat_errcalc/writer"
	"os"
	"path/filepath"
	"strconv"
	"time"
...
func printHelp() {
	...
	fmt.Println("")
	fmt.Println("=== Usage ===")
	fmt.Println("microsat_errcalc.exe <source file path> <output file name (optional)>")
	fmt.Println("")
	fmt.Println("=== Notes ===")
